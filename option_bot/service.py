...
def build_bot_from_env(env_get=os.environ.get):
    ...
    cfg = load_strategy_config(
        ...
        condor_commission_per_leg=_f(env_get('OBOT_CONDOR_COMMISSION_PER_LEG'), 0.0),
        ...
        condor_iv_source=(env_get('OBOT_CONDOR_IV_SOURCE') or 'computed').lower(),
        condor_close_strategy=(env_get('OBOT_CONDOR_CLOSE_STRATEGY') or 'threshold').lower(),
        condor_trail_activation=_f(env_get('OBOT_CONDOR_TRAIL_ACTIVATION'), 0.0),
        condor_trail_giveback=_f(env_get('OBOT_CONDOR_TRAIL_GIVEBACK'), 0.0),
        condor_iv_gate_mode=(env_get('OBOT_CONDOR_IV_GATE_MODE') or 'absolute').lower(),
        condor_min_iv_rank=_f(env_get('OBOT_CONDOR_MIN_IV_RANK'), 50.0),
        condor_iv_rank_floor=_f(env_get('OBOT_CONDOR_IV_RANK_FLOOR'), 0.0),
        condor_iv_rank_lookback_days=_i(env_get('OBOT_CONDOR_IV_RANK_LOOKBACK'), 252),
        condor_iv_rank_min_history=_i(env_get('OBOT_CONDOR_IV_RANK_MIN_HISTORY'), 60),
        condor_iv_rank_seed_from_vix=_b(env_get('OBOT_CONDOR_IV_RANK_SEED_FROM_VIX'), False),
        condor_iv_rank_vix_gap=_f(env_get('OBOT_CONDOR_IV_RANK_VIX_GAP'), 4.0),
        condor_iv_history_file=env_get('OBOT_CONDOR_IV_HISTORY_FILE') or '',
